...
export const Head = ({
  ...
  return (
    <NextHead>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Asap:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600&family=Lilita+One&display=swap" rel="stylesheet"></link>
    </NextHead>
  )
}
